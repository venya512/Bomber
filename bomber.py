...
def infinite(pn, dl, ch, max):
    ...
    while True:
        ...
        count_inf += 1
        # os.system('echo Navin >> count.xxx')
        time.sleep(float(dl))
        if (count_inf > maxlim):
            exit()
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To pepperjack1210@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        ...
        print("              This Bomber Was Created By Navin !!                ")
        print("==================================================================")
        try:
...
try:
    noti = urllib.request.urlopen(
        "https://raw.githubusercontent.com/pepperjack1210/Bomber/master/.notify").read().decode('utf-8')
...
try:
    ...
    type = 0
if type == 1:
    nm = int(input("Enter Number of Calls To Send(Maximum 200000): "))
    if nm > 200000:
...
if nm == 0:
    ...
    if nt <= 0 or nt >= 30:
        print('\Bomber Shows Better Result in 10 to 25 Threads\n\t\tStill Continuing....')
